      ...
      <div className="container">
        <div className="CancellationInner">
          ...
          <p className="CancellationText1 text-justify text-white">
            ...
            "our") and for bookings referred to us from our partners or
            completed by us on their behalf. By making a booking or payment
            with/to us, you agree to comply with this Policy.
          </p>
          ...
          <div>
            ...
            <ol className=" CancellationText2 text-justify">
              <li>
                ...
                Company using the following scale as a guide:
              </li>
              <li>24 hours or less: no refund.</li>
              <li>
                Over 24 hours: Full refund minus an admin fee of £7.00 (seven
                pounds) and a 2.5% transaction charge.
              </li>
              <li>
                To cancel a booking, please contact us through the provided
                channels. Cancellation requests will be processed according to
                the applicable cancellation policy.
              </li>
              <li>
                If your booking is eligible for a refund, the following
                guidelines apply:
              </li>
              <li>
              ...
              <li>
                Processing times for refunds may vary and typically take up to
                seven days from the date of cancellation.
              </li>
              <li>
                Refunds will be issued for the amount specified in the
            ...
            <ol className=" CancellationText2 text-justify">
              ...
              <li>
                We will track your incoming flight where possible, but in the
                case of long delays you may have to wait at the airport to be to
                be picked up depending on our other existing bookings.
              </li>
              <li>
                Customers are entitled to a free thirty (30) minutes of wait
                time. Any time exceeding is chargeable at rate of £0.50 (fifty
                pence) per minute, this equates to £30 per hour.
              </li>
              <li>
                It is your responsibility to inform us with immediate effect of
                any changes to your flight times, if you do not, we will not be
                held responsible for missed flights or your onward travel with
                us.
              </li>
              <li>
                We will suggest to you the best pick up time using our
                expertise, considering scheduled landing times and luggage (if
                applicable), but the final decision is yours.
              </li>
              <li>
                We will suggest to you the best pick up time using our
                expertise, considering scheduled landing times and luggage (if
              ...
              <li>
                We reserve the right to charge a supplement in the eventuality
                of your flight being delayed for over 2 hours or if your flight
            ...
            <ol className=" CancellationText2 text-justify">
              ...
              <li>
                Trips will be undertaken at the direction of the hirer or their
                appointed representative. Where none of those are available, the
                directions of guests or passengers will be taken.
              </li>
              <li>
                It is the responsibility of the hirer to make appropriate
                arrangements to maximise the use of time. The business accepts
                no liability or responsibility for the sequence of journeys or
                lack thereof.
              </li>
              <li>
                A driver and vehicle will be at the disposal of the hirer for
                the duration of hire and will remain on site for the said
                duration if no journeys are being undertaken.
              </li>
              <li>
                If during the duration of hire no trips are undertaken for any
            ...
            <ol className=" CancellationText2 text-justify">
              ...
              <li>
                Changes in the booking, such as date, time or addresses may
                result in additional charges or fees.
              </li>
              <li>
            ...
            <ol className=" CancellationText2 text-justify">
              ...
              <li>
                The passenger can make arrangements to collect said item from
                us, either in person or through a prepaid and self-addressed
                envelope or can arrange for us to deliver said item at a cost.
              </li>
              <li>
